...
<center><h3>Edit Chapter</h3></center>
<div class="container-fluid">
    <form @submit.prevent="Editchap">
        <div class="mb-3">
            <br>
...
const chapID = route.params.chapter_id

onMounted(async () => {
    try {
    const response = await fetch(`http://127.0.0.1:5000/api/edit-chapter/${chapID}`)
